...
export default class OpenWereld6 extends Scene {
  ...
  public constructor(maxX: number, maxY: number) {
    ...
    this.player.setPosX(1000);
    this.player.setPosY(561);
  ...
  public override processInput(mouseListener: MouseListener, keylistener: KeyListener): void {
    ...
    const xRegions: { lb: number; rb: number; } = { lb: 1320, rb: 1480 };
    const yRegions: { lo: number; ro: number } = { ro: 520, lo: 420 };
