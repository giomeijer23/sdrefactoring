...
export default class OpenWereld2 extends Scene {
  ...
  public constructor(maxX: number, maxY: number) {
    ...
    this.player.setPosX(199);
    this.player.setPosY(620);
  ...
  public override processInput(mouseListener: MouseListener, keylistener: KeyListener): void {
    ...
    const xRegions: { lb: number; rb: number; } = { lb: 540, rb: 660 };
    const yRegions: { lo: number; ro: number } = { ro: 580, lo: 480 };
