...
export default class Level4 extends Scene {
  ...
  public constructor(maxX: number, maxY: number) {
    ...
    this.dungeonEnemy = CanvasRenderer.loadNewImage('./assets/Finalboss_man.png');
  ...
  public override render(canvas: HTMLCanvasElement): void {
    ...
    CanvasRenderer.drawImage(canvas, this.dungeonEnemy, canvas.width / 1.3 - this.dungeonEnemy.width / 2, canvas.height / 1.58 - this.dungeonEnemy.height / 2);
